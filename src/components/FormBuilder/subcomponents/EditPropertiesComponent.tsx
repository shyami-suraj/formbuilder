...
const EditPropertiesComponent: FC<EditPropertiesComponentProps> = (props) => {
  ...
  const editIteminList = (item: FormLayoutCoponentChildrenItemsType) => {
    ...
    const itemToBeReplaced = newItems.find((i) => i.id === item.id);
    if (itemToBeReplaced) {
            ...
            <>
              <div className="main-form">
                <form onSubmit={onFormSubmit} style={{ minWidth: "100%" }}>
                  ...
                  childUpdatedItem.controlName === FormControlNames.INPUTNUMBERFIELD || 
                ...
                >
                  ...
                  <div>
                    <FormControl style={{ minWidth: "100%" }}>
                      ...
                      >
                        {props.formLayoutComponents.map((item, index) => {
                          return (
                            <MenuItem
